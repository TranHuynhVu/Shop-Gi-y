...
<c:url var="APIUrl" value="/api-web-new" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="<c:url value='/template/web/images/item-cart-01.jpg'/>"
								alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="<c:url value='/template/web/images/item-cart-02.jpg'/>"
								alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="<c:url value='/template/web/images/item-cart-03.jpg'/>"
								alt="IMG">
						</div>
		...
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1"
					style="background-image: url(<c:url value='/template/web/images/slide-01.jpg'/>)">
				...
				<div class="item-slick1"
					style="background-image: url(<c:url value='/template/web/images/slide-02.jpg'/>);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false"
				...
				<div class="item-slick1"
					style="background-image: url(<c:url value='/template/web/images/slide-03.jpg'/>);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false"
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="<c:url value='/template/web/images/banner-01.jpg'/>"
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<c:url value='/template/web/images/banner-02.jpg'/>"
							alt="IMG-BANNER"> <a href="product.html"
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<c:url value='/template/web/images/banner-03.jpg'/>"
							alt="IMG-BANNER"> <a href="product.html"
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
		...
		<div class="container">
			...
			<div class="row isotope-grid">
				<c:forEach var="list" items="${listShoes}">
					<div
						class="producttt col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
						<!-- Block2 -->
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="<c:url value='/template/web/images/product-01.jpg'/>"
									alt="IMG-PRODUCT"> <a href="#"
									class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1"
									data-price="${list.getPRICE()}" data-id="${list.getID()}" data-idshoes="${list.getID_SHOE()}" data-nameshoes="${list.getNAME()}"> Quick View </a>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-02.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-03.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-04.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-05.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-06.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-07.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-08.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item shoes">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-09.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-11.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-12.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-13.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-14.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-15.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<c:url value='/template/web/images/product-16.jpg'/>"
								alt="IMG-PRODUCT"> <a href="#"
								class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View </a>
						</div>
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img
						src="<c:url value='/template/web/images/icons/icon-close.png'/>"
						alt="CLOSE">
				</button>
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3"
										...
										<div class="wrap-pic-w pos-relative">
											<img
												src="<c:url value='/template/web/images/product-detail-01.jpg'/>"
												alt="IMG-PRODUCT"> <a
									...
									<div class="item-slick3"
										...
										<div class="wrap-pic-w pos-relative">
											<img
												src="<c:url value='/template/web/images/product-detail-02.jpg'/>"
												alt="IMG-PRODUCT"> <a
												class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
									...
									<div class="item-slick3"
										...
										<div class="wrap-pic-w pos-relative">
											<img
												src="<c:url value='/template/web/images/product-detail-03.jpg'/>"
												alt="IMG-PRODUCT"> <a
												class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
...
<!-- 	<script type="text/javascript">
	    $(".js-show-modal1").click(function() {
	        var idShoe = $(this).data("idshoe");
	        console.log(data);
	        $.ajax({
	            type: "GET",
	            url: "/shopbangiay-jsp-servlet/api-web-new",
	            data: JSON.stringify(idShoe),
