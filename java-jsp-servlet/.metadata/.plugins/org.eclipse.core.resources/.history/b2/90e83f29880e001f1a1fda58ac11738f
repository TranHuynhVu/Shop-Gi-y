				...
				<div class="row">
							...
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3"
										data-thumb="<c:url value='/template/web/images/product-detail-01.jpg'/>">
									...
									<div class="item-slick3"
										data-thumb="<c:url value='/template/web/images/product-detail-02.jpg'/>">
										<div class="wrap-pic-w pos-relative">
											<img
									...
									<div class="item-slick3"
										data-thumb="<c:url value='/template/web/images/product-detail-03.jpg'/>">
										<div class="wrap-pic-w pos-relative">
											<img
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							<h4 class="mtext-105 cl2 js-name-detail p-b-14" id="nameShoe" mame="mameshoe">Lightweight
								Jacket</h4>
	
							<span id="PRICE" class="mtext-106 cl2"> $58.79 </span>
							...
							<div class="p-t-33">
								...
								<div class="flex-w flex-r-m p-b-10">
									...
									<div class="size-204 respon6-next">
										<div class="rs1-select2 bor8 bg0">
											<select class="js-select2" name="colorsShoe" id="colorsShoe">
												<option>Choose an option</option>
											</select>
											<div class="dropDownSelect2"></div>
										</div>
