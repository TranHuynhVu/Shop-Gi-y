			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img class="imgShoe" src="<c:url value='/Images/Shoe image/Nike Air Force 1 07 LV8/air-force-1-07-lv8-6.png'/>"
							alt="IMG-BANNER"> <a href='<c:url value="/product?filtersort=Default&filterprice=all"/>'
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8"> Women shoe
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img class="imgShoe" src="<c:url value='/Images/Shoe image/Air Jordan Legacy 312 Low/Black white/black_white_8.png'/>"
							alt="IMG-BANNER">
						 <a href='<c:url value="/product?filtersort=Default&filterprice=all"/>'
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8"> Men shoe </span>

								<span class="block1-info stext-102 trans-04"> Spring 2024
								</span>
							</div>
				 ...
				 <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto"> 
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img class="imgShoe" src="<c:url value='/template/web/images/banner-03.jpg'/>"
							alt="IMG-BANNER"> <a href='<c:url value="/product?filtersort=Default"/>'
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
		...
		<div class="container">
							...
							<div class="filter-col1 p-r-15 p-b-27">
								<div class="mtext-102 cl2 p-b-15">Sort By</div>
									...
									<li class="p-b-6"><a href='<c:url value="/product"/>'
										class="filter-link stext-106 trans-04 filter-link-active"> Default </a></li>
			...
			<div class="row isotope-grid">
				<c:forEach var="list" items="${listShoes}">
					<div class="producttt col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <c:forEach var="item" items="${listShoesCate}"><c:if test="${item.getID() eq list.getID_SHOE()}"><c:out value="${item.getNAMEECATE()}"/></c:if></c:forEach>">
						<!-- Block2 -->
						<div class="block2">
