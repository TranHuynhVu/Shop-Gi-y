		...
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1"
					style="background-image: url('/shopbangiay-jsp-servlet/Images/Shoe image/Nike Air Max 90/Black white/black_white_8.png'); background-size: 85%;">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false"
								...
								<a href="/shopbangiay-jsp-servlet/product?filtersort=Default&filterprice=all"
				...
				<div class="item-slick1"
					style="background-image: url('/shopbangiay-jsp-servlet/template/web/images/banner-03.jpg'); background-size: 85%;">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false"
								data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2"> Accessories  </span>
							</div>
				...
				<div class="item-slick1"
					style="background-image: url('/shopbangiay-jsp-servlet/Images/Shoe image/Nike Air Max Plus/air-max-plus-shoes-4.png'); background-size: 85%;">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false"
								data-appear="rotateInDownLeft" data-delay="0">
								<span class="ltext-101 cl2 respon2"> Men Collection 2024
								</span>
							</div>

							<div class="layer-slick1 animated visible-false"
								data-appear="rotateInUpRight" data-delay="800">
								<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">Women Collection 2024
									arrivals</h2>
							</div>
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img class="imgShoe"
							src="<c:url value='/Images/Shoe image/Nike Air Force 1 07 LV8/air-force-1-07-lv8-6.png'/>"
							alt="IMG-BANNER"> <a
							href='<c:url value="/product?filtersort=Default&filterprice=all"/>'
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8"> Women
									shoe </span> <span class="block1-info stext-102 trans-04">
									Spring 2024</span>
							</div>
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img class="imgShoe"
							src="<c:url value='/Images/Shoe image/Air Jordan Legacy 312 Low/Black white/black_white_8.png'/>"
							alt="IMG-BANNER"> <a
							href='<c:url value="/product?filtersort=Default&filterprice=all"/>'
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img class="imgShoe"
							src="<c:url value='/template/web/images/banner-03.jpg'/>"
							alt="IMG-BANNER"> <a
							href='<c:url value="/product?filtersort=Default"/>'
							class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div
						...
						<div class="filter-col1 p-r-15 p-b-27">
							...
							<ul>
								<li class="p-b-6"><a href='<c:url value="/product"/>'
								...
								<li class="p-b-6"><a href="#"
									class="filter-link stext-106 trans-04 "> Newness </a></li>
						...
						<div class="block2">
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a
										href="/shopbangiay-jsp-servlet/product-detail?ID=${list.getID()}"
										data-id="${list.getID()}" data-nameshoes="${list.getNAME()}"
										data-idshoes="${list.getID_SHOE()}"
										data-price="${list.getPRICE()}" id="clickproductdetail"
