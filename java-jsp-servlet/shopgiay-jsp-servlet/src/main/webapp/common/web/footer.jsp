			...
			<div class="row">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								...
								<div class="item-slick3" id="imageDataThumb2"
									data-thumb="images/product-detail-02.jpg'/>">
									<div class="wrap-pic-w pos-relative">
										<img id="imageIMG2"
											src="<c:url value='/template/web/images/product-detail-02.jpg'/>"
											alt="IMG-PRODUCT"> <a id="imageA2"
											class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
								...
								<div class="item-slick3" id="imageDataThumb3"
									data-thumb="images/product-detail-03.jpg'/>">
									<div class="wrap-pic-w pos-relative">
										<img id="imageIMG3"
											src="<c:url value='/template/web/images/product-detail-03.jpg'/>"
											alt="IMG-PRODUCT"> <a id="imageA3"
											class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2" id="PRICE"> $58.79 </span>
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<input type="hidden" name="iddf" id="iddf" value="">
